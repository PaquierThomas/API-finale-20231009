...
INSERT INTO choix (partie_id, texte, image_url, prochain_partie_id, fin_jeu) VALUES
    (1, 'Aller vérifier', 'door.svg', 2, 0),
    (1, 'Ignorer et continuer à étudier', 'book.svg', 32, 1),
    (2, 'Revenir en arrière discrètement', 'retreat.svg', 34, 1),
    (2, 'S''approcher avec prudence', 'cautious.svg', 3, 0),
    (3, 'Offrir de l''aide', 'help.svg', 4, 0),
    (3, 'S''enfuir de peur', 'fear.svg', 33, 1),
    (4, 'À la bibliothèque de l''école', 'library.svg', 35, 1),
    (4, 'Dans un laboratoire de sciences abandonné', 'lab.svg', 5, 0),
    (5, 'Affronter Khon', 'alien.svg', 36, 1),
    (5, 'Chercher un autre chemin', 'path.svg', 6, 0),
    (6, 'Continuer à se cacher', 'hide.svg', 37, 1),
    (6, 'Chercher un moyen de fuir l''école', 'escape.svg', 7, 0),
    (7, 'Ouvrir la porte', 'door.svg', 38, 1),
    (7, 'Vérifier s''il y a des pièges', 'trap.svg', 8, 0),
    (8, 'Traverser rapidement', 'fast.svg', 39, 1),
    (8, 'Faire  le moins de bruit possible', 'slow.svg', 9, 0),
    (9, 'Se cacher dans les buissons', 'bush.svg', 10, 0),
    (9, 'Courir pour semer leurs poursuivants', 'run.svg', 39, 1),
    (10, 'Continuer à fuir', 'escape.svg', 11, 0),
    (10, 'Prendre un moment pour reprendre leur souffle', 'breathe.svg', 40, 1),
    (11, 'Suivre un cours d''eau', 'river.svg', 41, 1),
    (11, 'Monter à un arbre pour avoir une meilleure vue', 'tree.svg', 12, 0),
    (12, 'Oui, pour chercher de l''aide', 'help.svg', 13, 0),
    (12, 'Non, pour éviter d''attirer l''attention', 'no-help.svg', 42, 1),
    (13, 'Discrètement, en évitant d''attirer l''attention', 'stealth.svg', 43, 1),
    (13, 'Ouvertement, en demandant de l''aide', 'open-help.svg', 14, 0),
    (14, 'Rassurer les habitants sur la nature inoffensive de XB-3', 'reassure.svg', 15, 0),
    (14, 'Insister sur le fait que XB-3 est leur seul espoir contre Khon', 'hope.svg', 15, 0),
    (15, 'Se cacher dans les maisons du village', 'hide-village.svg', 16, 0),
    (15, 'Se préparer à affronter Khon et ses sbires', 'prepare-battle.svg', 44, 1),
    (16, 'Attendre que Khon parte', 'wait.svg', 45, 1),
    (16, 'Tenter d''investiger le bruit pendant que Khon est occupé', 'escape.svg', 17, 0),
    (17, 'Courir brutalement jusqu''au vaisseau', 'help.svg', 18, 0),
    (17, 'Se faufiler discrétement', 'no-help.svg', 18, 0),
    (18, 'Appuyer sur le premier bouton à vue', 'escape-ship.svg', 19, 0),
    (18, 'Appuyer sur tout les boutons', 'village-battle.svg', 19, 0),
    (19, 'Accélérer le décollage et fuir', 'fast-escape.svg', 20, 0),
    (19, 'Tenter de détruire le vaisseau de Khon avant de décoller', 'destroy-ship.svg', 46, 1),
    (20, 'Vers le centre spatial le plus proche pour demander de l''aide', 'space-center.svg', 21, 0),
    (20, 'Vers un endroit reculé de l''univers pour se cacher de Khon', 'hide-universe.svg', 47, 1),
    (21, 'Tenter de réparer le vaisseau eux-mêmes', 'repair-ship.svg', 22, 0),
    (21, 'Continuer malgré les dommages et espérer atteindre leur destination', 'damage.svg', 22, 0),
    (22, 'Tenter de décoder la transmission pour anticiper les plans de Khon', 'decode-transmission.svg', 23, 0),
    (22, 'Ignorer la transmission et se concentrer sur la réparation du vaisseau', 'ignore-transmission.svg', 48, 1),
    (23, 'Prévenir le centre spatial du danger imminent', 'warn-space-center.svg', 24, 0),
    (23, 'Tenter de trouver un moyen de contourner l''embuscade', 'ambush.svg', 49, 1),
    (24, 'Se préparer à affronter Khon directement', 'prepare-battle.svg', 25, 0),
    (24, 'Chercher une autre issue pour échapper à Khon', 'escape.svg', 25, 0),
    (25, 'Demander l''aide des autorités du centre spatial', 'space-center-help.svg', 26, 0),
    (25, 'Activer un signal de détresse pour appeler des renforts', 'distress-signal.svg', 26, 0),
    (26, 'Attendre l''arrivée des renforts au centre spatial', 'wait-space-center.svg', 50, 1),
    (26, 'Se rendre sur le lieu de l''embuscade pour prendre Khon par surprise', 'ambush-khon.svg', 27, 0),
    (27, 'Accepter l''aide des résistants et élaborer un plan ensemble', 'resistance-help.svg', 28, 0),
    (27, 'Refuser l''aide des résistants et continuer selon leur plan initial', 'no-resistance-help.svg', 51, 1),
    (28, 'Profiter de la confusion pour capturer Khon', 'capture-khon.svg', 52, 1),
    (28, 'Se battre jusqu''à ce que tous les sbires de Khon soient neutralisés', 'battle-khon.svg', 29, 0),
    (29, 'Le livrer aux autorités du centre spatial', 'deliver-khon.svg', 30, 0),
    (29, 'Lui offrir une chance de se repentir et de changer', 'repent-khon.svg', 53, 1),
    (30, 'Recevoir les éloges et les remerciements des autorités spatiales', 'praise.svg', 31, 0),
    (30, 'Rejoindre ses camarades', 'rest.svg', 31, 0),
    (31, 'Participer à une cérémonie de récompense en leur honneur', 'ceremony.svg', 32, 0),
    (31, 'Retourner à leur vie quotidienne avec un sentiment de satisfaction accomplie', 'return.svg', 54, 0),
    (32, 'Organiser une fête pour célébrer leur victoire', 'celebrate.svg', 55, 0),
    (32, 'Discuter des leçons apprises et des souvenirs de leur aventure', 'lesson-learned.svg', 56, 0);
